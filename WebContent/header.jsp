...
<div style="display: flex; flex-direction: row; align-items: center; background-color: pink; justify-content: space-between; padding: 10px 60px">
    ...
    <%
        ...
        if(userName != null) {
            ...
            out.println("<h3 style=\"padding-right: 10px\"><a href=\"listorder.jsp\">List Orders</a></h3>");
            out.println("<h3 style=\"padding-right: 10px\"><a href=\"customer.jsp\">Customer Info</a></h3>");
            out.println("<h3 style=\"padding-right: 10px\"><a href=\"warehouse.jsp\">Warehouse</a></h3>");
            out.println("<h3 align=\"center\"><a href=\"admin.jsp\">Admin</a></h2>");
            out.println("</div><div>");
